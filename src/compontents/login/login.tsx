        ...
        <MDBContainer className="p-3 my-5 d-flex flex-column w-50">
          ...
          <MDBTabsContent>
            <MDBTabsPane show={justifyActive === "tab1"}>
              ...
              <MDBBtn className="mb-4 w-100" onClick={() => handleRegisterLogin(justifyActive)}>
                Sign in
              </MDBBtn>
            ...
            <MDBTabsPane show={justifyActive === "tab2"}>
              ...
              <MDBBtn className="mb-4 w-100"  onClick={() => handleRegisterLogin(justifyActive)}>Sign up</MDBBtn>
            </MDBTabsPane>
          </MDBTabsContent>
        </MDBContainer>
      </div>
